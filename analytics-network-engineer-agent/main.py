...
# --- Discover MCP Tools (includes all Slack/Jira/Network tools via ACL) ---
...
# --- Create Agent ---
# Local tools: workspace ops + flapping analysis
# MCP tools: all Slack, Jira, Network device tools (centralized)
tools = [
    check_flapping_history,
    read_file,
    write_file,
